...
export default page(() => {
  return (
    <div className="w-full min-h-[100dvh]  flex items-center justify-center">
      <div className="w-full md:w-3xl min-h-full flex flex-col items-start justify-start md:my-2 my-8 py-2 bg-white rounded-lg shadow-md">
              ...
              >
                ...
                {stats && (
                  <div className="w-full max-w-lg flex flex-col p-1 px-2 mb-2 mt-3 mx-1 bg-slate-200/20 rounded-md ring-1 ring-slate-300/40 h-fit">
                    ...
                    <div className="w-full h-fit py-1 grid grid-cols-3">
                      {stats.map((stat, i) => (
                        <div
                          key={`stat-${i}`}
